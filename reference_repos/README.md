...
自 2026-06-06 起，任何联网查到并被用于修改 TokenShare 设计、代码、测试或项目文档的开源项目或工程实现，都必须先拉取到本目录再引用。新增条目至少记录：上游仓库、commit/tag、拉取范围、选择原因、观察重点，以及该项目影响到的 TokenShare 文档或模块。不能只在 TDD、README 或回答中留下在线仓库链接。
