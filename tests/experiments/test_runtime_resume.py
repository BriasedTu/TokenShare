...
def test_pre_flash_exp2_terminal_ledger_reprojects_once_without_transport(
    ...
    from tokenshare.experiments import runtime
    from tokenshare.experiments.cli import _CliRootContext
    from tokenshare.experiments.schema import (
    ...
    from tokenshare.experiments.storage import RunStore
    from tests.experiments.test_scenarios import (
...
def test_typed_terminal_and_response_are_reused_without_second_call(
    ...
    from tokenshare.experiments.storage import RunStore
    from tests.experiments.test_answer_paths import (
        _FakeResponse,
        _control,
        _entry,
        _response_body,
...
def test_interrupted_response_is_parsed_offline_and_terminalized(
    ...
    from tokenshare.experiments import runtime
    from tokenshare.experiments.provider import ProviderCallContextV1
    from tokenshare.experiments.storage import RunStore
    from tests.experiments.test_answer_paths import (
        _control,
        _entry,
...
def test_dead_intent_becomes_unknown_and_only_next_ordinal_calls_provider(
    ...
    from tokenshare.experiments import provider, runtime
    from tokenshare.experiments.provider import (
        ProviderCallContextV1,
        call_provider_once,
    )
...
def test_live_intent_owner_refuses_resume_without_terminal(tmp_path: Path) -> None:
    from tokenshare.experiments import runtime
    from tokenshare.experiments.provider import ProviderCallContextV1
    from tokenshare.experiments.storage import RunStore, StorageConflictError
    from tests.experiments.test_answer_paths import _control, _entry
...
def test_fresh_protocol_resume_calls_only_the_missing_factor_tail_target(
    ...
    from tests.experiments.test_system_vertical import _inventory
...
def test_non_tail_exp1_protocol_resume_never_constructs_provider_or_coverage_tail(
    ...
    from tokenshare.experiments import cli, provider, runtime
    from tokenshare.experiments.storage import RunStore
    from tests.experiments.test_answer_paths import (
        _PromptResponseFactory,
        _answer_path_factor_case,
...
def test_normal_parse_exhaustion_completes_unscheduled_coverage_tail(
    ...
    assert "experiments_runtime_failure" not in snapshot.protocol_result["summary"]
...
def test_lean_parse_exhaustion_completes_unscheduled_coverage_tail(
    ...
    from tokenshare.experiments import cli, provider, runtime
    from tokenshare.experiments.execution import FixedTraceSubmissionAdapter
    from tokenshare.experiments.storage import RunStore, select_trace_attempt
...
def test_lean_checker_infrastructure_terminal_blocks_coverage_tail() -> None:
    from tokenshare.experiments.runtime import coverage_tail_blocked
...
def test_infrastructure_snapshot_resume_never_requires_provider(
    ...
    from tokenshare.experiments import cli
    from tokenshare.experiments.storage import RunStore
    from tests.experiments.test_answer_paths import _answer_path_factor_case
    from tests.experiments.test_system_vertical import _inventory
