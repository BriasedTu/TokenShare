...
FACTOR_CATALOG_PATH = REPO_ROOT / "benchmarks/experiments/factorization_catalog.v2.jsonl"
LEAN_CATALOG_PATH = REPO_ROOT / "benchmarks/experiments/lean_lemma_graph_catalog.v1.jsonl"
...
def _profiles() -> ModuleType:
    return importlib.import_module("tokenshare.experiments.profiles")
...
def test_full_condition_and_root_counts_match_canonical_inventory() -> None:
    from tokenshare.experiments.profiles import build_inventory
...
def test_full_attempt_and_provider_call_hard_caps_are_derived_from_inventory() -> None:
    from tokenshare.experiments.profiles import build_inventory, build_plan
...
def test_exp4_full_challenge_quotas_and_mode_expansion_are_exact() -> None:
    from tokenshare.experiments.profiles import EXP4_MODES, build_inventory
...
def test_representative_inventory_jsonl_round_trips_to_task1_projector_input(
    ...
    from tokenshare.experiments.schema import RootInventoryV1
