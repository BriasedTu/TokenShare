...
from tokenshare.experiments import reducer as reducer_module
from tokenshare.experiments.reducer import (
...
def test_reduce_run_golden_all_experiments_and_io_boundary(
    ...
    reducer_path = Path(__file__).parents[2] / "src/tokenshare/experiments/reducer.py"
