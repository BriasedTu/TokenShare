"""TokenShare Experiments Experiment 2--4 场景接线的风险驱动验证。"""
...
from tokenshare.experiments.profiles import ChallengePlanV1
from tokenshare.experiments.projector import RootProjectionError, project_root_result
from tokenshare.experiments.runtime import (
    RootAssembly,
    materialize_protocol_traces,
    run_root_slice,
)
from tokenshare.experiments.scenarios import (
...
class _ContentAwareRecordingLeanChecker(RecordingLeanChecker):
    ...
    def __call__(self, request, *, artifact_store, environment_manifest):
        ...
        self.status = (
            ...
            if "nonexistent_experiments_identifier" in str(proof_body.get("proof_source"))
