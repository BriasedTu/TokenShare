...
from tokenshare.experiments.slim_v2.storage import RunStore, StorageConflictError, scan_resume
...
def test_provider_caller_is_single_bounded_closed_and_secret_free(
    ...
    monkeypatch.setenv("SLIM_V2_TEST_KEY", "never-persist-this-secret")
...
def test_provider_configuration_invalid_is_condition_fail_stop_before_transport(
    ...
    from tokenshare.experiments.slim_v2 import provider
    from tokenshare.experiments.slim_v2.execution import (
...
def test_started_exp1_configuration_failure_projects_incorrect_root(
    ...
    assert protocol_result.summary["slim_condition_failure"] == {
...
def test_provider_submission_adapter_completes_factorization_root_and_fixed_fallback(
    ...
    tail_range_ref = artifact_store.save_json(
        ...
        artifact_schema_version="v1",
        source={"kind": "slim_v2_test_tail_fixture"},
