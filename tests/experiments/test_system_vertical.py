...
from tokenshare.experiments.schema import AttemptResultV1, RootInventoryV1
...
LEAN_CATALOG_PATH = Path("benchmarks/experiments/lean_lemma_graph_catalog.v1.jsonl")
...
def _test_lean_environment() -> LeanEnvironmentManifest:
    ...
    return LeanEnvironmentManifest.from_project(
        project_root=Path("benchmarks/experiments/fixtures/lean_proof_project"),
