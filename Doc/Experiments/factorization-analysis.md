# Experiment 1 Factorization analysis

## Purpose and scope

The standalone, read-only extractor analyzes the published
...
`src/tokenshare/experiments/factorization_exp1_analysis.py`. The local raw full-run
