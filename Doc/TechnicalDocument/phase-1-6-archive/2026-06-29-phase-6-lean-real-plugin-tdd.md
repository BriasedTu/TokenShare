...
| 创建日期 | 2026-06-29 |
| 主要依据 | `AGENTS.md`、`Doc/agent-navigation.md`、`Doc/TechnicalDocument/tokenshare_latest_real_plugin_experiment_design.md`、`Doc/TechnicalDocument/2026-06-28-phase-6-lean-real-plugin-scope-change.md`、`Doc/TechnicalDocument/lean_proof_decomposition_rules.tex`、Phase 6 factorization field spec / code map、Phase 8 experiment infrastructure code map |
