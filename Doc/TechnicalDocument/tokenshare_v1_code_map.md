...
| 文件 | 默认输出类别 |
|---|---|
| `run_paper_pipeline.py` | 统一 14 个正式命令的 parser/delegation/门禁入口；历史 strict publication 流仍可显式 opt-in，unknown/missing 为 exit 2，正式资源阻塞为 JSON/exit 3。 |
