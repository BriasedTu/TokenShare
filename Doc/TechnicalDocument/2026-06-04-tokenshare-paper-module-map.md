...
| Lean 证明插件：proof state、premise retrieval、verifier | 未来 Lean adapter 可接入 proof state、premise retrieval 和 verifier/replay 工作流；V1 只使用 one-shot synthetic fixture checker。 | P19: *LeanDojo: Theorem Proving with Retrieval-Augmented Language Models* | `tokenshare-paper-tex/P19_leandojo.tex` | <https://proceedings.neurips.cc/paper_files/paper/2023/file/4441469427094f8873d0fecb0c4e1cee-Paper-Datasets_and_Benchmarks.pdf> |
| Lean 实验 benchmark | 借鉴 miniF2F 的版本固定、题型/难度分层和问题集合身份；V1 不下载或运行实际 miniF2F 子集。 | P20: *miniF2F: a Cross-System Benchmark for Formal Olympiad-Level Mathematics* | `tokenshare-paper-tex/P20_minif2f.tex` | <https://arxiv.org/pdf/2109.00110> |
| Lean verifier 环境背景 | mathlib 说明 proof checker 依赖具体 library/toolchain/namespace 语境；V1 的 environment identity 主要按 P19 的 verifier/workflow 边界建模。 | P21: *The Lean Mathematical Library* | `tokenshare-paper-tex/P21_lean_mathlib.tex` | 原草稿源：<https://doi.org/10.1145/3372885.3373824>；下载源：<https://leanprover-community.github.io/papers/mathlib-paper.pdf> |
