...
30. `Doc/TechnicalDocument/2026-06-29-phase-8-experiment-infrastructure-code-map.md`：Phase 8 第一版实验基础设施 source/tests/边界和验证证据映射；用于确认 `feat-009` 已实现边界和后续扩展点。
