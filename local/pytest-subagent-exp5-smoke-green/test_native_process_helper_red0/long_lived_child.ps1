...
$terminatePath = 'E:\TokenEcnomic\TokenShare\local\pytest-subagent-exp5-smoke-green\test_native_process_helper_red0\child.terminate'
...
[Console]::Error.Flush()
Set-Content -Encoding UTF8 -LiteralPath 'E:\TokenEcnomic\TokenShare\local\pytest-subagent-exp5-smoke-green\test_native_process_helper_red0\child.ready' -Value $PID
